...
export const asset = pgTable(
	...
	(table) => [
		...
		check(
			"asset_type_check",
			sql`(asset_type)::text = ANY ((ARRAY['bgm'::character varying, 'soundEffect'::character varying, 'characterImage'::character varying, 'backgroundImage'::character varying, 'cg'::character varying])::text[])`,
		),
	],
);
