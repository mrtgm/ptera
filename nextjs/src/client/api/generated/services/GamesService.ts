...
export class GamesService {
	 ...
	 * @throws ApiError
	 */
	public getApiV1Games(gameId: number | string): CancelablePromise<{
		success: boolean;
		data: {
			scenes: Array<
				| {
	 ...
	 * @throws ApiError
	 */
	public getApiV1GamesAssets(gameId: number | string): CancelablePromise<{
		success: boolean;
		data: {
			character: Record<
				string,
	 ...
	 * @throws ApiError
	 */
	public postApiV1Games(requestBody?: {
		name: string;
		description: string | null;
	}): CancelablePromise<{
		success: boolean;
	 ...
	 * @throws ApiError
	 */
	public postApiV1GamesPlay(gameId: number | string): CancelablePromise<{
		success: boolean;
		data: {
			count: number;
		};
	 ...
	 * @throws ApiError
	 */
	public getApiV1GamesComments(gameId: number | string): CancelablePromise<{
		success: boolean;
		data: Array<{
			id: number;
			userId: number;
